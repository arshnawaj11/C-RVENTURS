...
$res1=mysqli_query($conn,"SELECT * FROM vehicledetails,customer_list WHERE vehicledetails.customerid=customer_list.customerid AND vehicledetails.customerid=$id"); //sending data for pending.php
...
<head>
<meta charset="utf-8">
<title>cusromer registration form</title>
