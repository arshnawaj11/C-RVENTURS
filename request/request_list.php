...
<body>
    <div id="app" >
        ...
        <div id="main" >
                            ...
                            <div class="card-body py-0 px-0">
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-x0">
                                        <img  class="pro_pic" src="../ssets/images/faces/2.png" alt="Face 1">
                                    </div>
            ...
            <div class="hedder" >
    <a href="../index.html"><h7>DASHBOARD /</h7></a> <a href="pendignservice.php"><h7 style="color:gray;">Request</h7></a>
...
echo"<td>"; ?> <a href="delete.php?rid=<?php echo $row["rid"]; ?>"> <button type="button" class="btn btn-danger"style="background-color:#ff4d4d ">Delete</button> </a> <?php echo"</td>";
