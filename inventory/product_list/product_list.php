                ...
                <div class="sidebar-menu">
                    <ul class="menu"> 
						...
						<li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                <li class="submenu-item ">
                                    <a href="../add_product/add_product.php">Add New Product</a>
                                </li>
                                <li class="submenu-item ">
...
<div class="newvehical">
    <div class="hedder" >
    <a href="../index.html"><h7>DASHBOARD /</h7></a> <a href="new_customerservice.php"><h7 style="color:blue;">Product List</h7></a>
...
<div id="" style="width:100%;background-color: ;">
...
<div class="filters">
        ...
        <li><input class="search_input" type="text" name="search" placeholder="By ID" id="myInput"  onkeyup="find1Function()"></li>
            ...
            <li><input class="search_input" type="text" name="search" placeholder="Brand" id="my3Input"  onkeyup="find4Function()"></li>
  ...
  <ul>
        <li>
            <li><div id="add_item" style="">
   <a href="../add_product/add_product.php"><input type="button" id="ad_item" name="Add item" value="Add item" ></a>
</div></li>
            <li><div id="add_item" style="">
   <input type="button" id="ad_item" name="Add item" value="Add Category" onclick="window.open('../add_categorie/add_categorie.php','popUpWindow','height=500,width=400,left=100,top=100,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no, status=yes');">
</div></li>
