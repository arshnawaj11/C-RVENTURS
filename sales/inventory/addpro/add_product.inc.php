...
$sql = "INSERT INTO product(pro_id,pro_name, category, brand, buy_price, sell_price, quantity, description)
        VALUES('$p_id','$product_name', '$category','$brand','$buy_price', '$sell_price', '$quantity', '$description')";
