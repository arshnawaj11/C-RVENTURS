...
$sql1 = "INSERT INTO pendingservice(customerid,cusname,cuscontact,vehiclenumber,vehicletype,brand,model,bodytype,milage,year,serviceid,sectionalhead,employer,p_datee,p_stime)
VALUES ('$customerid','$cusname','$cuscontact','$vehiclenumber','$vehicletype','$brand','$model','$bodytype','$milage','$year','$serviceid','$sectionalhead','$employer','$p_datee','$p_stime')";
