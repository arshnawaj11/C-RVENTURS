...
.search_submit{
  ...
  background:#4d4dff;
            ...
            <div class="hedder" >
    <a href="../index.html"><h7 style="color:lightblue;">DASHBOARD /</h7></a> <a href="new_customerservice.php"><h7 style="color:Gray;">NEW MESSAGE</h7></a>
...
echo"<td>"; ?> <a href="send_message.php?customerid=<?php echo $row["customerid"]; ?>"> <button type="button" class="btn btn-success"style="background-color:#5cd65c">Send Message</button> </a> <?php echo"</td>";
