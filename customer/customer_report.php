...
<div class="newvehical">
    <div class="hedder" >
    <a href="../index.html" style="color:lightblue;"><h7>DASHBOARD /</h7></a> <a href="new_customerservice.php"><h7 style="color:gray;">CUSTOMER REPORT</h7></a>
...
echo"<td>"; ?> <a href="cus_report_view.php?customerid=<?php echo $row["customerid"]; ?>"  onClick="return popup(this, 'notes')"> <button type="button" class="btn btn-danger"style="background-color:#ff4d4d ">View</button> </a> <?php echo"</td>";
